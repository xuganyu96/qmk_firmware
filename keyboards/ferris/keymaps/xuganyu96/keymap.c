...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [1] = LAYOUT_split_3x5_2(
      ...
      XXXXXXX,  XXXXXXX,   KC_LT,    KC_GT,   KC_DOT,               KC_0,     KC_1,     KC_2,     KC_3,   KC_ENT,
    ...
    */
    [3] = LAYOUT_split_3x5_2(
      XXXXXXX,  MS_BTN1,   MS_UP,  MS_BTN2,  MS_WHLU,            XXXXXXX,  XXXXXXX, XXXXXXX,   XXXXXXX,  XXXXXXX,
      XXXXXXX,  MS_LEFT, MS_DOWN,  MS_RGHT,  MS_WHLD,            XXXXXXX,  XXXXXXX, XXXXXXX,   XXXXXXX,  XXXXXXX,
      XXXXXXX,  XXXXXXX, XXXXXXX,  XXXXXXX,  XXXXXXX,            XXXXXXX,  XXXXXXX, XXXXXXX,   XXXXXXX,  XXXXXXX,
